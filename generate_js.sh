...
cat $P/log.js $P/resultset.js $P/jquery.cookie.js $P/commands.js $P/jquery.bootstrapMessage.js $P/jquery.bootstrapLoadModal.js $P/bootstrap-slide.js $P/cssrule.js > $P/all-p2.js
